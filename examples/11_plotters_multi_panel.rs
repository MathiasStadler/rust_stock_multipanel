...
const OUT_FILE_NAME: &str = "plotters-doc-data/11_stock.png";
...
fn get_data_from_csv() -> Vec<(String, f64, f64, f64, f64, f64)> {
    // fn get_data_from_csv() -> Vec<(&'static String, f64, f64, f64, f64, f64)> {
    // Vec<(&'static str, f32, f32, f32, f32)>

    //double
    // let return_vec: Vec<(&str, f64, f64, f64, f64, f64)> = Vec::new();
...
// cargo run --example 11_plotters_multi_panel
